...
class BeerControllerTest {
    ...
    void beerIsReturnedById() throws Exception {
        BeerDTO testBeer = beerServiceImpl.getAllBeers(null, null).get(0);
    ...
    void newBeerIsPersisted() throws Exception {
        BeerDTO beerWithoutId = beerServiceImpl.getAllBeers(null, null).get(0);
        beerWithoutId.setId(null);
        beerWithoutId.setVersion(null);

        BeerDTO beerWithId = beerServiceImpl.getAllBeers(null, null).get(1);
    ...
    void allBeersAreListed() throws Exception {
        ...
        verify(beerService, times(1)).getAllBeers(null, null);
    }
}