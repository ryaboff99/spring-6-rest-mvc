...
class BeerControllerTest {
    ...
    void newBeerIsPersisted() throws Exception {
        BeerDTO beerWithoutId = beerServiceImpl.getAllBeers(null, null, false).get(0);
        beerWithoutId.setId(null);
        beerWithoutId.setVersion(null);

        BeerDTO beerWithId = beerServiceImpl.getAllBeers(null, null, false).get(1);
    ...
    void allBeersAreListed() throws Exception {
        ...
        verify(beerService, times(1)).getAllBeers(any(), any(), any());
    }
}